...
<center>
  <table id="appointment"> 
   ...
   <tbody>
<?php
$result=mysqli_query($conn,"select * from  appointments_table");
// print_r($result);
$cnt=1;
              ...
              <td><?php  echo $row['AptTime'];?></td>
               <td><?php
                ...
                $aid = $row['aid'];
                 ...
                 $sql ="SELECT s.ServiceName FROM appointments_services aps join services_table s on aps.sid = s.sid
                where aps.aid =$aid";
                $result1 =$conn->query($sql);
                echo "<ul>";
                while($row1=$result1->fetch_assoc()){?>
                  <li><?php echo $row1['ServiceName']?></li>
                <?php } ?>
                <ul>
               ...
               <td><?php  echo $row['Remark'];?></td>
                <td> 
                  <a href="edit-appointment.php?aid=<?php echo $row['aid'];?>">Edit</a> 
                  <a href="delete-appointment.php?aid=<?php echo $row['aid'];?>">Delete</a>
