...
<center>
	<table id="customer"> <thead> <tr> <th>SN</th> <th>Username</th><th>Password</th><th>creation_at</th><th>Action</th> </tr> </thead> <tbody>
<?php
$ret=mysqli_query($conn,"select *from  customers_table");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {

?>

             <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['username'];?></td> <td><?php  echo $row['password'];?></td> <td><?php  echo $row['created_at'];?></td> <td><a href="delete-customer.php?cid=<?php echo $row['cid'];?>">Delete</a></td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
