...
<center>
	<table id="service"> <thead> <tr> <th>SN</th> <th>Service Name</th> <th>Service Price</th> <th>Creation Date</th><th>Action</th> </tr> </thead> <tbody>
<?php
...
?>
             ...
             <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['ServiceName'];?></td> <td><?php  echo $row['Cost'];?></td><td><?php  echo $row['CreationDate'];?></td> <td><a href="edit-service.php?sid=<?php echo $row['sid'];?>">Edit</a> 
              <a href="delete-service.php?sid=<?php echo $row['sid'];?>">Delete</a></td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
          </div>
        </div>
