...
<center>
	<table id="comment"> <thead> <tr> <th>SN</th> <th>Name</th><th>Email</th><th>Comment</th><th>Action</th> </tr> </thead> <tbody>
<?php
...
?>
             ...
             <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['name'];?></td> <td><?php  echo $row['email'];?></td> <td><?php  echo $row['comment'];?></td> <td><a href="edit-comment.php?id=<?php echo $row['id'];?>">Edit</a> <a href="delete-comment.php?id=<?php echo $row['id'];?>">Delete</a></td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
